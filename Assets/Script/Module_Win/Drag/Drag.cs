...
//给空间添加监听事件要实现的一些接口
public class Drag : HttpBase, IPointerDownHandler, IDragHandler, IPointerUpHandler,
    IEndDragHandler, IPointerEnterHandler, IPointerExitHandler
{
    ...
    Vector3 imgReduceScale = new Vector3(1.1f, 1.1f, 1);   //设置图片缩放
    Vector3 imgNormalScale = new Vector3(1, 1, 1);   //正常大小

    Vector2 StartanchoredPosition;

    public Attempt<PointerEventData> TryerDrag= new Attempt<PointerEventData>();
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
        ...
        mainScene.MainSceenFeed(imgRect.position);
        offset = Vector2.zero;
        imgRect.anchoredPosition = StartanchoredPosition;
    }
    ...
    protected override void Init()
    {
        ...
        StartanchoredPosition = imgRect.anchoredPosition;
        TryerDrag.AddListener(Move);
    }
}